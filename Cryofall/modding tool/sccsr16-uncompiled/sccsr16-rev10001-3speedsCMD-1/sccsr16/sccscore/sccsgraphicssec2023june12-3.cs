                    ...
                    if (foldername.ToLower() == "atomictorchstudio")
                    {
                        ...
                        foreach (var modfolder in listofmodfolders)
                        {
                            ...
                            if (themodfoldername != "sccspathfind.mpk")
                            {
                                ...
                                if(themodfoldernamewithoutextension.ToLower() == "mobs")//any MOB MOds or MOBS files correctly set in hieararchy.//"TODO-mobs-TODO"
                                {
                                    ...
                                    if (creatempkpermobornot == 0)
                                    {
                                        for (int f = 0; f < arrayofthescriptfiles.Length; f++)
                                        {
                                            ...
                                            string pathtocharactermobsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts" + "\\Characters" + "\\Mobs";
                                            string pathtocharacterskeletonsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts" + "\\CharacterSkeletons";
                                            string pathtoitemsweaponsmobweaponsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts" + "\\Items" + "\\Weapons" + "\\MobWeapons";
                                            string pathtozonesscriptmobsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts" + "\\Zones" + "\\Scripts" + "\\Mobs";
                                            //FOR MAKING FOLDERS FOR PNG FILES TO BE COPIED


                                            string pathtoPNGSmobsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Content" + "\\Animations" + @"\" + removetheextensionfrommobname + @"\" + "images";
                                            string pathtoPNGSmobsbackmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Content" + "\\Animations" + @"\" + removetheextensionfrommobname + @"\" + "images" + @"\" + "Back";
                                            string pathtoPNGSmobsfrontmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Content" + "\\Animations" + @"\" + removetheextensionfrommobname + @"\" + "images" + @"\" + "Front";
                                            string pathtoPNGSmobsAnimationmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Content" + "\\Animations" + @"\" + removetheextensionfrommobname;
                                            ...
                                            else
                                            {
                                                ...
                                                string pathtoanimationpngs = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + "\\Content\\Animations\\" + removetheextensionfrommobname + "\\images"; //back/male and /front/male
                                                string pathtoscripts = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts";
                                                string pathtoscriptsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts";
                                                ...
                                                if (removetheextensionfrommobname.ToLower() != "mobs")
                                                {
                                                    for (int i = 0; i < numberofvariants; i++)
                                                    {
                                                        if (debugtoconsole == 1)
                                                        ...
                                                        createvariantpngs(i, pathtoanimationpngs, themodfoldernamewithoutextension, 2, removetheextensionfrommobname);
                                                        ...
                                                        //createvariantscripts(i, themodfoldernamewithoutextension, pathtoscripts, pathtoscriptsmul, themodfoldernamewithoutextension, 2, removetheextensionfrommobname);
...
".Add(GetScript<SpawnMobs" + "Skeleton" + "Variant" + "8" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r"
        ...
        public unsafe void createvariantpngs(int variantindex, string pathtoanimationpngs, string themodfoldernamewithoutextension, int thetypeofgenerator,string removetheextensionfrommobname)
        {
            ...
            */
            ...
            string finalPathanims = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname; // + @"\" + "images"
            ...
            string finalPathanims1 = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname; // + @"\" + "images"
            string finalPathanims2 = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname; // + @"\" + "images"
            ...
            string finalPathweapon = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images"; // + @"\" + "images"
            ...
            if (variantindex == 0)
            {
                ...
                if (themodfoldernamewithoutextension.ToLower() == "skeleton" || themodfoldernamewithoutextension.ToLower() == "zombie")
                {
                    finalPathanimsf = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Front" + @"\" + "Male"; // + @"\" + "images"
                    finalPathanimsb = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Back" + @"\" + "Male"; // + @"\" + "images"

                }
                else
                {
                    finalPathanimsf = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Front" ; // + @"\" + "images"
                    finalPathanimsb = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Back" ; // + @"\" + "images"
                ...
                if (themodfoldernamewithoutextension.ToLower() == "skeleton" || themodfoldernamewithoutextension.ToLower() == "zombie")
                {
                    finalPathPNGSf = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images" + @"\" + "Front" + @"\" + "Male"; // + @"\" + "images"
                    finalPathPNGSb = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images" + @"\" + "Back" + @"\" + "Male"; // + @"\" + "images"

                }
                else
                {
                    finalPathPNGSf = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images" + @"\" + "Front"; // + @"\" + "images"
                    finalPathPNGSb = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images" + @"\" + "Back"; // + @"\" + "images"
                ...
                //copy weapon not sure if that is necessary now
                string finalPathweapon1 = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images"; // + @"\" + "images"
                var arrayoforiginalweapon1 = Directory.GetFiles(finalPathweapon1);
                ////Console.WriteLine(finalPathweapon1);
                string finalPathweapon2 = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images"; // + @"\" + "images"
                ...
                //copy weapon not sure if that is necessary now
                string finalPathweapon11 = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname; // + @"\" + "images"
                var arrayoforiginalanims11 = Directory.GetFiles(finalPathweapon11);
                ////Console.WriteLine(finalPathweapon1);
                string finalpathanims = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname; // + @"\" + "images"
        ...
        public void createvariantscripts(int variantindex, string mobname, string pathtoscripts, string pathtoscriptsmul, string themodfoldernamewithoutextension, int thetypeofgenerator, string removetheextensionfrommobname)// double mobspeed, double mobhp, float mobheight
        {
