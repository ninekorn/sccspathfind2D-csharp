...
namespace sccs
{
    public class sccsgraphicssec : sccsdirectx, IDisposable
    {
        ...
        public sccsgraphicssec()
        {
            ...
            Console.Title = "Mobs variants builder/creator for Cryofall V1.33.1.15 - sccsr16-rev-1.0004 - made by steve chassé aka ninekorn. updated 2023/july/13";
                    ...
                    foreach (var dir in dirs)
                    {
                        ...
                        //if (foldername.ToLower() == "multiplied")
                        {
                            ...
                            var maincopythread = new Thread((tester0000) =>
                            {
                                ...
                                List<string> listofmobbacktexturename = new List<string>();
                                                                        ...
                                                                        if (foldername.ToLower() == "mobs.mpk")
                                                                        {
                                                                            ...
                                                                            if (generatescriptsswtc == 1)
                                                                            {
                                                                                ...
                                                                                //if (ateststring.Length > 3)
                                                                                {
                                                                                    ...
                                                                                    if (thenameofthefilewithoutextension0.Length >= "skeleton".Length + 1)
                                                                                    {
                                                                                        ...
                                                                                        if (getthefirsteightletters.ToLower() == "skeleton")
                                                                                        {
                                                                                            for (int r = 0; r < 9; r++)
                                                                                            {
                                                                                                ...
                                                                                                if (thefilenamewithoutskeletoninit.ToLower().Contains("pragmiumqueen") || thefilenamewithoutskeletoninit.ToLower().Contains("sandtyrant") || thefilenamewithoutskeletoninit.ToLower().Contains("thumper"))
                                                                                                {
                                                                                    ...
                                                                                    if (thenameofthefilewithoutextension.Length >= "mob".Length + 1)
                                                                                    {
                                                                                        if (getfirstfewletters.ToLower() == "mob")
                                                                                        {
                                                                                            for (int r = 0; r < 9; r++)
                                                                                            {
                                                                                                ...
                                                                                                if (thefilenamewithoutmobinit.ToLower().Contains("pragmiumqueen") || thefilenamewithoutmobinit.ToLower().Contains("sandtyrant") || thefilenamewithoutmobinit.ToLower().Contains("thumper"))
                                                                                                {
                                                                                                ...
                                                                                                else
                                                                                                {
                                                                                                    ...
                                                                                                    //CHECKING IF THE PATH OF THE NEW VARIANT ALREADY EXISTS
                                                                                                    if (!File.Exists(thevariantfilepath)) // && !thenameofthefilewithoutextension.ToLower().Contains("thumper")
                                                                                                    {
                                                                                                        //COPYING THE VARIANT TO THE DRIVE.
                                                                                                        File.Copy(poppedstring, thevariantfilepath);
                                                                                                    }
                                                                                                    ...
                                                                                                    if (File.Exists(thevariantfilepath))
                                                                                                    {
                                                                                                        ...
                                                                                                        string thefinalmovespeedstr = thefinalmovespeedstring.ToString(); //  2.015
                                                                                                        ...
                                                                                                        //ItemWeaponMobSkeletonSwordsubstringofthespeed1
                                                                                                        ...
                                                                                                        if (thefilenamewithoutmobinit.ToLower() == "pragmiumqueen" || thefilenamewithoutmobinit.ToLower() == "sandtyrant" || thefilenamewithoutmobinit.ToLower() == "thumper")
                                                                                                        {
                                                                                                            //Console.WriteLine("***********************" + thefilenamewithoutmobinit);

                                                                                                            /*
                                                                                                            //MobBossPragmiumQueen.PrivateState
                                                                                                            //<MobBossPragmiumQueen
                                                                                                            string thenameofmobtoreplace = "<Mob" + thefilenamewithoutmobinit;
                                                                                                            string thenameofmobthatreplaces = "<Mob" + thefilenamewithoutmobinit ;
                                                                                                          ...
                                                                                                          Replace(thenameofmobthatreplaces, thefilenamewithoutmobinit + scriptnamevariant));*/
                                                                                                            /*File.WriteAllText(thevariantfilepath, File.ReadAllText(thevariantfilepath).
                                                                                                            Replace(scriptvarnames, scriptvarnames + scriptnamevariant).
                                                                                    ...
                                                                                    //SPAWN SECTION//SPAWN SECTION//SPAWN SECTION//SPAWN SECTION//SPAWN SECTION//SPAWN SECTION//SPAWN SECTION//SPAWN SECTION
                                                                                    ...
                                                                                    //ITEM WEAPON SECTION//ITEM WEAPON SECTION//ITEM WEAPON SECTION//ITEM WEAPON SECTION//ITEM WEAPON SECTION//ITEM WEAPON SECTION
                                                                            ...
                                                                            if (ateststring.Length > 3 + 1)
                                                                            {
                                                                                ...
                                                                                if (thenameofthefilewithoutextension1 == "png")
                                                                                {
                                                                                    ...
                                                                                    if (ateststring.ToLower().Contains("pragmiumqueen") || ateststring.ToLower().Contains("sandtyrant") || ateststring.ToLower().Contains("thumper"))
                                                                                    {
                                                                                            ...
                                                                                            for (int r = 0; r < 9; r++)
                                                                                            {
                                                                                                ...
                                                                                                if (poppedstring.Length > thepathtovariantpngsparentfolder.Length)
                                                                                                {
                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                           //if (finalfilename.ToLower().Contains("images"))
                                                                                                    {
                                                                                                        ...
                                                                                                        {
                                                                                                            //Console.WriteLine(ateststring);
                                                                                                            if (finalfilename.ToLower().Contains("back"))
                                                                                                            {
                                                                                                                getrandvalues(out rand, out randr, out randb, out randg);
                                                                                                        ...
                                                                                                        {
                                                                                                            getrandvalues(out rand, out randr, out randb, out randg);
                                                                                                            listofmobbacktexturename.Add(themobname + "r" + r);
                                                                                                        }
                                                                                                        else
                                                                                                        {
                                                                                                            if (themobname + "r" + r == )
                                                                                                        ...
                                                                                                        if (lastmobname != themobname)
                                                                                                        {
                                                                                                            getrandvalues(out rand, out randr, out randb, out randg, themobname);
                    ...
                    foreach (var thefolder in dirsmod)
                    {
                        ...
                        if (thefoldernameinsideofcryofall.ToLower() == "zones")
                        {
                            ...
                            for (int i = 0; i < arrayofzones.Length; i++)
                            {
                                ...
                                double densitymul = 0.05; // 0.03 // 0.09
        ...
        public void getrandvalues(out float rand, out float randb, out float randg, out float randr,string themobname)
        {

            //float rand = (float)sc_maths.getSomeRandNum(0.75f, 1);

            float minrandm = 0.90f; //0.998f
            float maxrandm = 1.05f;//1.015f //0.999f
            ...
            */
            ...
            if (themobname.ToLower().Contains("skeleton"))
            {

                //ORIGINAL
                 minrandg = 0.90f; //0.90fs
                 maxrandg = 0.99f;//1.015f //0.999f

                 minrandb = 0.90f; //0.998f
                 maxrandb = 0.99f;//1.015f //0.999f

                 minrandr = 0.90f; //0.998f
                 maxrandr = 0.99f;//1.015f //0.999f
                //ORIGINAL
            }
