                                                                        ...
                                                                        if (!File.Exists(thecopiedfilepath))
                                                                        {
                                                                            ...
                                                                            if (foldername.ToLower() == "mobs.mpk")
                                                                            {
                                                                                ...
                                                                                else if (foldername2.ToLower() == "mobs" && foldername2.ToLower() != foldername.ToLower())
                                                                                {
                                                                                    ...
                                                                                    else if (getfirstfiveletters.ToLower() == "spawn")
                                                                                    {
                                                                                        /*
                                                                                        //CHARACTERS FOLDER
                                                                                        string thenameofthefilewithoutextension = ateststring.Substring(0, ateststring.Length - 3);
                                                                                ...
                                                                                else if (foldername2.ToLower() == "mobweapons")
                                                                                {
                                                                                    string thenameofthefilewithoutextension = ateststring.Substring(0, ateststring.Length - 3);
                                                                                    ...
                                                                                    if (thefilenamewithoutiteminit != "")
                                                                                    {
                                                                                        ...
                                                                                        for (int r = 0; r < 9; r++)
                                                                                        {
                                                                                            string scriptname = "ItemWeaponMobSword" + themobname + thefilenamewithoutiteminit + "r" + r + ".cs";

                                                                                            string thevariantfilepath = thefinalpath + @"\" + scriptname;
                                                                                            ...
                                                                                            File.WriteAllText(thevariantfilepath, File.ReadAllText(thevariantfilepath).Replace(scriptname, "Sword" + thefilenamewithoutiteminit ));
