                                                                                            ...
                                                                                            if (poppedstring.Length > thepathtovariantpngsparentfolder.Length)
                                                                                            {
                                                                                                ...
                                                                                                //if (finalfilename.ToLower().Contains("images"))
                                                                                                {
                                                                                                    ...
                                                                                                    */
                                                                                                    ...
                                                                                                    //Console.WriteLine(thepngfilenamewithextinverted);
                                                                                                    //Console.WriteLine(removeimages + separator + themobname + "r" + r);


                                                                                                    //Console.WriteLine(themobname + "r" + r);
                                                                                                    ...
                                                                                                    if (!Directory.Exists(thepathtovariantpngsparentfolderout))
                                                                                                    {
                                                                                                        ...
                                                                                                        //string thepathtovariantpngsparentfolderin = sccsr16.Form1.currentform.theselectedfolderin + separator + foldername + separator + "Content" + separator + "Animations" + separator + themobname + removethebeginningfromthestringkeeptheend;// + removethecrap;

                                                                                                        //dirs1last.Push(thepathtovariantpngsparentfolderin);
                                                                                                    }
