namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr0 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr0 currentMobSkeletonClassr0;
        ...
        public override double StatMoveSpeed => 0000000000000000000000000000002.00500000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr0>();
        ...
        {
            currentMobSkeletonClassr0 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr0>();// ItemWeaponMobSkeletonSwordr0 //ItemWeaponMobSandTyrantMelee
