namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombier6 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombier6 currentMobZombieClassr6;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000212.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.53900000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombier6>();
        ...
        {
            currentMobZombieClassr6 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordZombier6>();
