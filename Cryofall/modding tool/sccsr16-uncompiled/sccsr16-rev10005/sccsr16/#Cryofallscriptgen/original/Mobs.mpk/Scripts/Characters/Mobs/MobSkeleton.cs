namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeleton : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeleton currentMobSkeletonClass;
        ...
        public override double StatMoveSpeed => 00000000000000000000000000000002.00000000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeleton>();
        ...
        {
            currentMobSkeletonClass = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeleton>();// ItemWeaponMobSkeletonSword //ItemWeaponMobSandTyrantMelee
