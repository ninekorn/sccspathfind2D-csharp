namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr8 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr8 currentMobSkeletonClassr8;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000099.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.98300000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr8>();
        ...
        {
            currentMobSkeletonClassr8 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr8>();// ItemWeaponMobSkeletonSwordr8 //ItemWeaponMobSandTyrantMelee
