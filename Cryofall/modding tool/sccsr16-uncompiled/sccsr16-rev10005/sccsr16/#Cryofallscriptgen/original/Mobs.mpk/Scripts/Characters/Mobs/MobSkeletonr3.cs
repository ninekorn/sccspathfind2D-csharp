namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr3 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr3 currentMobSkeletonClassr3;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000088.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.04400000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr3>();
        ...
        {
            currentMobSkeletonClassr3 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr3>();// ItemWeaponMobSkeletonSwordr3 //ItemWeaponMobSandTyrantMelee
