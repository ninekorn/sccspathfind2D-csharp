namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr1 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr1 currentMobSkeletonClassr1;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000117.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.00400000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr1>();
        ...
        {
            currentMobSkeletonClassr1 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr1>();// ItemWeaponMobSkeletonSwordr1 //ItemWeaponMobSandTyrantMelee
