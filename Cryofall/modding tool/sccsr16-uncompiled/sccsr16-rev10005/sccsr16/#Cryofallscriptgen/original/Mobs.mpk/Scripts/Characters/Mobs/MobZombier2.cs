namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombier2 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombier2 currentMobZombieClassr2;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000234.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.50600000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombier2>();
        ...
        {
            currentMobZombieClassr2 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordZombier2>();
