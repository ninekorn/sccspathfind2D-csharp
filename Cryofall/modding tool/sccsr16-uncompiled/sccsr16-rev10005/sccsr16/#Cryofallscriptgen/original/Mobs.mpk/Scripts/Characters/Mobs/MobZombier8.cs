namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombier8 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombier8 currentMobZombieClassr8;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000190.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.51100000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombier8>();
        ...
        {
            currentMobZombieClassr8 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordZombier8>();
