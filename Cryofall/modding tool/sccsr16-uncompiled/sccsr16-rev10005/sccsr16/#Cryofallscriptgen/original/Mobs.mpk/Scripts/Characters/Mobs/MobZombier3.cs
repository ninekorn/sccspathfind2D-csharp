namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombier3 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombier3 currentMobZombieClassr3;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000235.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.5200000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombier3>();
        ...
        {
            currentMobZombieClassr3 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordZombier3>();
