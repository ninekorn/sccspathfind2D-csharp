namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr6 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr6 currentMobSkeletonClassr6;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000113.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.03400000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr6>();
        ...
        {
            currentMobSkeletonClassr6 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr6>();// ItemWeaponMobSkeletonSwordr6 //ItemWeaponMobSandTyrantMelee
