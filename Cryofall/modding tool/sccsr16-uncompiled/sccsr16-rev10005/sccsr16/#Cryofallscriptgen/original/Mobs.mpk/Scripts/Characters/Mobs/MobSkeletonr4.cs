namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr4 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr4 currentMobSkeletonClassr4;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000097.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.98800000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr4>();
        ...
        {
            currentMobSkeletonClassr4 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr4>();// ItemWeaponMobSkeletonSwordr4 //ItemWeaponMobSandTyrantMelee
