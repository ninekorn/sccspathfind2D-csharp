namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr7 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr7 currentMobSkeletonClassr7;
        ...
        public override double StatMoveSpeed => 0000000000000000000000000000002.02500000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr7>();
        ...
        {
            currentMobSkeletonClassr7 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr7>();// ItemWeaponMobSkeletonSwordr7 //ItemWeaponMobSandTyrantMelee
