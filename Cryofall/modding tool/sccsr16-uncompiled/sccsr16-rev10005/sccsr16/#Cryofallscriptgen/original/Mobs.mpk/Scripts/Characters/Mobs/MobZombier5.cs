namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombier5 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombier5 currentMobZombieClassr5;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000205.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.52100000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombier5>();
        ...
        {
            currentMobZombieClassr5 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordZombier5>();
