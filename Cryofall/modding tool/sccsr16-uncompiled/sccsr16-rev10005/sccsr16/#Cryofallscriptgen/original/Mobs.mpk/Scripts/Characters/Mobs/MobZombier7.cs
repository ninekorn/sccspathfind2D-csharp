namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombier7 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombier7 currentMobZombieClassr7;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000181.00000000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombier7>();
        ...
        {
            currentMobZombieClassr7 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordZombier7>();
