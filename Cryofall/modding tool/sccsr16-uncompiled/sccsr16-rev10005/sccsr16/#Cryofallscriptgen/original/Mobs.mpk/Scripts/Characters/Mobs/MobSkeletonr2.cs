namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonr2 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonr2 currentMobSkeletonClassr2;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000111.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.98900000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonr2>();
        ...
        {
            currentMobSkeletonClassr2 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordSkeletonr2>();// ItemWeaponMobSkeletonSwordr2 //ItemWeaponMobSandTyrantMelee
