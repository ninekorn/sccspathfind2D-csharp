namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombier4 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombier4 currentMobZombieClassr4;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000217.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.52200000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombier4>();
        ...
        {
            currentMobZombieClassr4 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSwordZombier4>();
