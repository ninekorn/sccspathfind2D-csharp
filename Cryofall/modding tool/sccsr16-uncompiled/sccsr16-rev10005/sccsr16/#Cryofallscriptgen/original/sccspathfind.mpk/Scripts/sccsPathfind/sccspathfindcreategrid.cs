...
namespace AtomicTorch.CBND.CoreMod.Scripts.sccsPathfind
{
    public static class sccspathfindcreategrid
    {
        ...
        public static sccspathfinddata startcreategrid(sccspathfindnode thegridlinknode, sccsvec2int initialpositioningrid, sccsvec2int targetobjingridpos, sccspathfindgridworldindex sccspathfindgridworldindex, out sccspathfindgriddatafinal gridinfo, int pathfinditeration, int alternateoption, sccsvec2int newgridlinkposition, System.Collections.Generic.List<sccspathfindobstaclestruct> listofobstacles, sccspathfinddata sccspathfinddata) //sccspathfindnode thegridlinknode //sccsvec2int seekerpositioningrid, //, sccsvec2int gridlastinitpos
        {
                ...
                for (int y = -sccspathfinddata.gridyb; y <= sccspathfinddata.gridyt; y++)
                {
                    ...
                    */
                    ...
                    if (listofobstacles.Count > 0)
                    {
                        ...
                        {
                            if (listofobstacles[i].obstaclenodeswtc == 1)
                            {
                                sccsvec2int centerpositionofrotation = new sccsvec2int();
                                centerpositionofrotation.x = ((int)listofobstacles[i].theobstacleposition.x) - sccspathfinddata.initialpathfindnpcpos.x;
                                centerpositionofrotation.y = ((int)listofobstacles[i].theobstacleposition.y) - sccspathfinddata.initialpathfindnpcpos.y;
                                ...
                                else
                                {
                                    ...
                                    if (centerpositionofrotation.x == posoftile2d.x && centerpositionofrotation.y == posoftile2d.y)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            /*var theobstaclestruct = listofobstacles[i];
                                            theobstaclestruct.obstaclenodeswtc = 2;
                                            listofobstacles[i] = theobstaclestruct;*/
