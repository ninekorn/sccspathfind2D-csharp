    ...
    public static class sccspathfindupdatemain
    {
        ...
        public static sccspathfinddata pathfindupdatemainfunction(sccsvec2float npcpos, sccsvec2float targetpos, System.Collections.Generic.List<sccspathfindobstaclestruct> listofobstacles, ICharacter npccharacter_, ICharacter playercharacter_, sccspathfinddata pathfindscript)
        {
            if (pathfindscript.startpathfind == 1)
            {
                ...
                sccsvec2int npcinitposofpathfindzerozero = sccspools.getpooledsccsvec2int(); //new sccsvec2int(); //sccspools.getpooledsccsvec2int();//
                ...
                {
                    pathfindscript.sccspathfindcombineddatavar.openset = sccspools.getpooledsccspathfindnodelist();// 
                }
                else
                {
                ...
                {
                    pathfindscript.sccspathfindcombineddatavar.closedset = sccspools.getpooledsccspathfindnodelist();// 
                }
                else
                {
                ...
                if (pathfindscript.sccspathfindcombineddatavar.log == null)
                {
                    ...
                    pathfindscript.sccspathfindcombineddatavar.log = sccspools.getpooledsccspathfindnodelistarray();// 
                }
                else
                {
                ...
                if (pathfindscript.retracedpathlist == null)
                {
                    ...
                    pathfindscript.retracedpathlist = sccspools.getpooledsccspathfindnodestack();// 
