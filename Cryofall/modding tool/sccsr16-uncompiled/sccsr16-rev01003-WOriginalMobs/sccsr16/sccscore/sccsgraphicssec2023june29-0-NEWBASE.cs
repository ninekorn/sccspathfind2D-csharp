        ...
        public unsafe void createvariantpngs(int variantindex, string pathtoanimationpngs, string themodfoldernamewithoutextension, int thetypeofgenerator)
        {
            ...
            */
            ...
            if (variantindex == 0)
            {
                ...
                if (themodfoldernamewithoutextension.ToLower() == "skeleton" || themodfoldernamewithoutextension.ToLower() == "zombie")
                {
                    finalPathPNGSf = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Front" + @"\" + "Male"; // + @"\" + "images"
                    finalPathPNGSb = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Back" + @"\" + "Male"; // + @"\" + "images"
                }
                else
                {
                    finalPathPNGSf = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Front"; // + @"\" + "images"
                    finalPathPNGSb = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Back"; // + @"\" + "images"
