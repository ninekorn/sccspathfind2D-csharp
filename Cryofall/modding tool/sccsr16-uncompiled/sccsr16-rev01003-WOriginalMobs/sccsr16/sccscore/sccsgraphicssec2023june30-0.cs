...
namespace sccs
{
    public class sccsgraphicssec : sccsdirectx, IDisposable
    {
                ...
                foreach (var dir in dirs)
                {
                    ...
                    if (foldername.ToLower() == "#cryofallscriptgen")
                    {
                        ...
                        foreach (var thefolder in dirsmod)
                        {
                            ...
                            if (thefoldernameinsideofcryofall.ToLower() == "skeleton0")
                            {
                                ...
                                for (int i = 0; i < numberofvariants; i++)
                                {
                                    ...
                                    createvariantpngs(i, pathtoanimationpngs, thefoldernameinsideofcryofall, 0);
                                    if (debugtoconsole == 1)
                                    {
                            ...
                            else if (thefoldernameinsideofcryofall.ToLower() == "zombie0")
                            {
                            ...
                            else if (thefoldernameinsideofcryofall.ToLower() == "zones")
                            {
                                    ...
                                    for (int v = 0; v < arrayofthezonescripts.Length; v++)
                                    {
                                        ...
                                        for (int f = 0; f < arrayofthecharacterskeletonfiles.Length; f++)
                                        {
                                            ...
                                            for (int varianti = 0; varianti < 1; varianti++)//9
                                            {
                                                ...
                                                File.WriteAllText(thepathtofilewithext, File.ReadAllText(thepathtofilewithext).Replace(strtoreplace, strtoreplace + removetheextensionfrommobname + "Variant" + varianti + "scripts" +
                                               ...
                                               /* File.WriteAllText(thepathtofilewithext, File.ReadAllText(thepathtofilewithext).Replace(strtoreplace + removetheextensionfrommobname + "Variant" + varianti, strtoreplace + removetheextensionfrommobname + "Variant" + varianti + "scripts" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\n" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "0" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\n" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "1" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\n" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "2" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\n" +
                                                ...
                                                //File.WriteAllText(thepathtofilewithext, File.ReadAllText(thepathtofilewithext).Replace(strtoreplace, strtoreplace + removetheextensionfrommobname + "\r" + "\n"  + "scripts" +
                                                //  ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + varianti + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" + "\n" + strtoreplace + removetheextensionfrommobname));
                                            }


                                            /*File.WriteAllText(thepathtofilewithext, File.ReadAllText(thepathtofilewithext).Replace(strtoreplace, strtoreplace + removetheextensionfrommobname + ));




                                            File.WriteAllText(thepathtofilewithext, File.ReadAllText(thepathtofilewithext).Replace(strtoreplace, strtoreplace + "\r" + "scripts" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "0" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "1" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "2" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "3" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "4" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "5" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "6" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "7" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
                                                    ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "8" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r"
                                                    + "\n" + strtoreplace));
                                            */
                                            //Console.WriteLine(f);
                                ...
                                ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "8" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r"
                                        ...
                                        if (removetheextensionfrommobname != string.Empty)
                                        {
                                ...
                                for (int m = 0; m < 3; m++)
                                {
                                    if (m == 0) 
                                    {
                                        ...
                                        for (int f = 0; f < arrayofthescriptfiles.Length; f++)
                                        {
                                            ...
                                            //string theskeletonstr = removetheextensionfrommobname;// "skeleton";

                                            //var removetheextensionfrommobname0 = removetheextensionfrommobname.Substring(theskeletonstr.Length, removetheextensionfrommobname.Length - theskeletonstr.Length);
                                            //Console.WriteLine(removetheextensionfrommobname);

                                            //sccsr16.Program.MessageBox((IntPtr)0, "removetheextensionfrommobname:" + removetheextensionfrommobname, "sccsmsg", 0);
                                            ...
                                            for (int j = 0; j < 1; j++)//skeleton and zombie variants
                                            {
                                                for (int i = 0; i < arrayofzones.Length; i++)
                                                {
                                                    //preparezones(j, currentfolderzone, pathToDesktop + @"\" + folderNameCryofallPNGScriptVariantBuilder, i, prefinalpathtofiles, prefinalpathtofilesmultiplied, pathtozones, removetheextensionfrommobname);
                                                    preparezonesnew(j, currentfolderzone, pathToDesktop + @"\" + folderNameCryofallPNGScriptVariantBuilder, i, prefinalpathtofiles, prefinalpathtofilesmultiplied, pathtozones, removetheextensionfrommobname);
                                    ...
                                    else if (m  == 10)
                                    {
                                        ...
                                        for (int f = 0; f < arrayofthescriptfiles.Length; f++)
                                        {
                                            ...
                                            for (int j = 0; j < 1; j++)//skeleton and zombie variants
                                            {
                                                for (int i = 0; i < arrayofzones.Length; i++)
                                                {
                                                    preparezones(i, currentfolderzone, pathToDesktop + @"\" + folderNameCryofallPNGScriptVariantBuilder, i, prefinalpathtofiles, prefinalpathtofilesmultiplied, pathtozones, removetheextensionfrommobname);
                                                }
                                            }
                            ...
                            else if (thefoldernameinsideofcryofall.ToLower() == "mobs0")
                            {
                                    ...
                                    //    removetheextensionfrommobname.ToLower() == "bearpolar")
                                    {
                                        ...
                                        //if (removetheextensionfrommobname.ToLower() == "skeleton")
                                        {
                                            ...
                                            for (int i = 0; i < numberofvariants; i++)
                                            {
                                                ...
                                                createvariantpngs(i, pathtoanimationpngs, removetheextensionfrommobname, 1);
                                                if (debugtoconsole == 1)
                                                {
                                                ...
                                                if (debugtoconsole == 1)
                                                {
                                                    Console.WriteLine("end creating Scripts/ variants " + i + " color/hp/speed/height for the original mob " + removetheextensionfrommobname.ToLower() + ".");
                                                }
                                            }
                                        }
                                        //PNGS
                                            ...
                                            if (removetheextensionfrommobname1.ToLower() == removetheextensionfrommobname.ToLower())
                                            {
                                                ...
                                                removetheextensionfrommobname.ToLower() != "starfish")
                                                {
                                                    ...
                                                    for (int i = 0; i < numberofvariants; i++)
                                                    {
                                                        ...
                                                        //createvariantpngsfororiginalmobs(i, pathtoanimationpngs, themodtogetmobsfrom, 2, removetheextensionfrommobname, pathtoanimations, pathtoanimationsmul);
                                                        ...
                                                        if (debugtoconsole == 1)
                                                        {
                                                            Console.WriteLine("start creating Scripts/ variants " + i + " color/hp/speed/height for the original mob " + removetheextensionfrommobname.ToLower() + ".");
                                                        }
            ...
            if (swtcforonoff == 2)// FAIL
            {
                ...
                foreach (var dir in dirs)
                {
                    ...
                    if (foldername.ToLower() == "#cryofallscriptgen")
                    {
                        ...
                        for (int f = 0; f < arrayofthescriptfiles.Length; f++)
                        {
                            ...
                            removetheextensionfrommobname.ToLower() != "starfish")
                            {
                                ...
                                for (int i = 0; i < numberofvariants; i++)
                                {
                                    ...
                                    createvariantscriptsfororiginalmobs(i, removetheextensionfrommobname, pathtoscripts, pathtoscriptsmul, removetheextensionfrommobname, 0);
                        ...
                        //string modpath = pathToDesktop + @"\" + foldername + @"\" + "original" + @"­\" + "Mobs"  + ".mpk" + @"\" ;//+ @"\"                                                                                                                    //Console.WriteLine("modpath: " + modpath);
                ...
                {
                    Console.WriteLine("the user doesn't have the folder #CryofallScriptGen on the desktop");
                }
            }
                        ...
                        foreach (var modfolder in listofmodfolders)
                        {
                            ...
                            if (themodfoldername != "sccspathfind.mpk")
                            {
                                ...
                                else if (themodfoldernamewithoutextension.ToLower() == "zones")
                                {
                                    ...
                                    for (int j = 0; j < 1; j++)//skeleton and zombie variants and original mobs variant
                                    {
                                        for (int i = 0; i < arrayofzones.Length; i++)
                                        {
                                ...
                                else if (themodfoldernamewithoutextension.ToLower() == "mobs")//any MOB MOds or MOBS files correctly set in hieararchy.//"TODO-mobs-TODO"
                                {
                                    ...
                                    if (creatempkpermobornot == 0)
                                    {
                                        for (int f = 0; f < arrayofthescriptfiles.Length; f++)
                                        {
                                            ...
                                            string pathtoPNGSmobsAnimationmul = prefinalpathtofilesmultiplied + @"\" + removetheextensionfrommobname + ".mpk" + "\\Content" + "\\Animations" + @"\" + removetheextensionfrommobname;
                                            ...
                                            string pathtoPNGSmobsAnimation = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Content" + "\\Animations" + @"\" + removetheextensionfrommobname;
                                            ...
                                            for (int fi = 0; fi < arrayoffiles7.Length; fi++)
                                            {
                                                string thefilemobname1 = arrayoffiles7[fi].Substring(pathtoPNGSmobsAnimation.Length + 1, (arrayoffiles7[fi].Length) - pathtoPNGSmobsAnimation.Length - 1);
                                           ...
                                           */
                                            ...
                                            if (removetheextensionfrommobname.ToLower() == "broodnest")
                                            {
                                                ...
                                                for (int fi = 0; fi < arrayoffiles4.Length; fi++)
                                                {
                                                    string thefilemobname1 = arrayoffiles4[fi].Substring(pathtoPNGSmobs.Length + 1, (arrayoffiles3[fi].Length) - pathtoPNGSmobs.Length - 1);
                                ...
                                else //if (themodfoldernamewithoutextension.ToLower() == "bear")
                                {
                                    if (themodfoldernamewithoutextension.ToLower() != "zones")
                                    {
                                        string pathtoanimationpngs = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Content\\Animations\\" + themodfoldernamewithoutextension + "\\images"; //back/male and /front/male
                                        string pathtoscripts = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts";
                                        string pathtoscriptsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts";
                                    ...
                                    if (themodfoldernamewithoutextension.ToLower() != "mobs")
                                    {
        ...
        public unsafe void preparezonesnew(int variantindex, string zonefolderselected, string pathoriginal, int indexofzone, string prefinalpathtofiles, string prefinalpathtofilesmultiplied, string pathtozones, string removetheextensionfrommobname)
        {
           ...
           //for (int i = 0; i < arrayofthezonescripts.Length; i++)
            {
               /* var substring = arrayofthezonescripts[i].Substring(lengthofpath, arrayofthezonescripts[i].Length - lengthofpath);
                ...
                */
                ...
                if (!File.Exists(thepathtofilewithext))
                {
                    File.Copy(arrayofthezonescripts[i], thepathtofilewithext, true);
        ...
        ".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "8" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r"
            ...
            public unsafe void preparezones(int variantindex, string zonefolderselected, string pathoriginal, int indexofzone, string prefinalpathtofiles, string prefinalpathtofilesmultiplied, string pathtozones, string removetheextensionfrommobname)
        {
...
".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + "8" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r"
                   + "\n" + strtoreplace));*/
                    ...
                    /*
                    Console.WriteLine("variantindex:" + variantindex);

                    
                    File.WriteAllText(thepathtofilewithext, File.ReadAllText(thepathtofilewithext).Replace(strtoreplace, strtoreplace + "\r" + "scripts" +
//".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r" +
".Add(GetScript<SpawnMobs" + removetheextensionfrommobname + "Variant" + variantindex + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r"
                   + "\n" + strtoreplace));*/
        ...
        public unsafe void createvariantpngsfororiginalmobs(int variantindex, string pathtoanimationpngs, string themodfoldernamewithoutextension, int thetypeofgenerator, string removetheextensionfrommobname, string pathtoanimations, string pathtoanimationsmul)
        {
            ...
            */
            ...
            string[] arrayoforiginalpngfilesanims;
            ...
            string mobname = removetheextensionfrommobname;
            ...
            if (removetheextensionfrommobname.ToLower() == "skeleton" || removetheextensionfrommobname.ToLower() == "zombie")
            {
                finalPathmulBack = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + themobfolder + @"\" + "images" + @"\" + "Back" + @"\" + "Male" + @"\";
                finalPathmulFront = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + themobfolder + @"\" + "images" + @"\" + "Front" + @"\" + "Male" + @"\";


            }
            else
            {
                finalPathmulBack = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + themobfolder + @"\" + "images" + @"\" + "Back" + @"\";
                finalPathmulFront = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + themobfolder + @"\" + "images" + @"\" + "Front" + @"\";
            }
            ...
            if (!Directory.Exists(pathtoanimationsmul + "Variant" + variantindex + @"\"))
            {
                Directory.CreateDirectory(pathtoanimationsmul + "Variant" + variantindex + @"\"); // + @"\" + "Zones"
            }
                ...
                removetheextensionfrommobname.ToLower() == "wolfpolar")
            {
                ...
                arrayoforiginalpngfilesanims = Directory.GetFiles(pathtoanimations);



                for (int fi = 0; fi < arrayoforiginalpngfilesanims.Length; fi++)
                {
                    string thefilemobname1 = arrayoforiginalpngfilesanims[fi].Substring(pathtoanimations.Length + 1, (arrayoforiginalpngfilesanims[fi].Length) - pathtoanimations.Length - 1);

                    File.Copy(arrayoforiginalpngfilesanims[fi], pathtoanimationsmul + "Variant" + variantindex + @"\" + thefilemobname1, true);
                }
                ...
                for (int i = 0; i < arrayoforiginalpngfilesfront.Length; i++)
                {
                    ...
                    if (textureinit)
                    {
                        ...
                        //string finalfilename = arrayoforiginalpngfilesfront[i].Substring(finalPathmulback.Length-2, (arrayoforiginalpngfilesfront[i].Length-1 - finalPathmulback.Length - 1));
        ...
        public void createvariantscriptsfororiginalmobs(int variantindex, string mobname, string pathtoscripts, string pathtoscriptsmul, string themodfoldernamewithoutextension, int thetypeofgenerator)// double mobspeed, double mobhp, float mobheight
        {
            ...
            for (int i = 0; i < arrayoforiginalscriptfilesMOB.Length; i++)
            {
                ...
                */
                ...
                string theclassmobmod = theclassmobori + "Variant" + variantindex;

                //Console.WriteLine("theclassmobori:" + theclassmobori + "/theclassmobori:" + theclassmobori + scriptnamevariant);
                //Console.WriteLine("theclassmobori:" + theclassmobori);//
                //Console.WriteLine(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs");

                string pathoffile = filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs";
                Console.WriteLine("theclassmobmod:" + theclassmobmod);//

                //File.WriteAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs", File.ReadAllText(arrayoforiginalscriptfilesMOB[i]).
                //Replace(theclassmobori, theclassmobori + "Variant" + variantindex));

                /*
                 string thescriptmodded = File.ReadAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs").//arrayoforiginalscriptfilesMOB[i]).
                  Replace(scriptvarnames, scriptvarnames + scriptnamevariant).
                  Replace(scriptcharacterskeletonstring, scriptcharacterskeletonstring + scriptnamevariant).
                  Replace(originalsub1, substringofthehp).
                  Replace(originalsub, substringoftheheight).
                 ...
                 File.WriteAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs", thescriptmodded);
                */


                File.WriteAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs", File.ReadAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs").//arrayoforiginalscriptfilesMOB[i]).
                  Replace(scriptvarnames, scriptvarnames + scriptnamevariant).
                  Replace(scriptcharacterskeletonstring, scriptcharacterskeletonstring + scriptnamevariant).
                  Replace(originalsub1, substringofthehp).
                  Replace(originalsub, substringoftheheight).
                ...
                //GRAB THE XML PROJECTS FILES.

                //File.WriteAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs", thescriptmodded);


                //Console.WriteLine(thescriptmodded);
                ...
                //File.WriteAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs", File.ReadAllText(filenamewithextmul + (thefinalfilename + "Variant" + variantindex) + ".cs").
                // Replace(theclassmobori, theclassmobori + scriptnamevariant));
