                    ...
                    if (foldername.ToLower() == "atomictorchstudio")
                    {
                        ...
                        foreach (var modfolder in listofmodfolders)
                        {
                            ...
                            if (themodfoldername != "sccspathfind.mpk")
                            {
                                ...
                                //Console.WriteLine("TEST" + themodfoldernamewithoutextension);
                                    ...
                                    if (creatempkpermobornot == 0)
                                    {
                                        for (int f = 0; f < arrayofthescriptfiles.Length; f++)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                string pathtoscripts = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + "\\Scripts";
                                                string pathtoscriptsmul = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + "\\Scripts";


                                                if (removetheextensionfrommobname != "zones")
                                                {
...
".Add(GetScript<SpawnMobs" + "Skeleton" + "Variant" + "8" + ">().Configure(densityMultiplier: " + densitymultiplier + "))" + "\r"
        ...
        public unsafe void createvariantpngs(int variantindex, string pathtoanimationpngs, string themodfoldernamewithoutextension, int thetypeofgenerator,string removetheextensionfrommobname)
        {
            ...
            */
            ...
            string[] arrayoforiginalpngfilesanims = null ;// Directory.GetFiles(finalPathanims);

            if (thetypeofgenerator == 2)
            {
                finalPathanims = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname; // + @"\" + "images"
                arrayoforiginalpngfilesanims = Directory.GetFiles(finalPathanims);

            }
            else
            {

                finalPathanims = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname; // + @"\" + "images"
                arrayoforiginalpngfilesanims = Directory.GetFiles(finalPathanims);
            ...
            if (thetypeofgenerator == 2)
            {
                finalPathanims1 = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname; // + @"\" + "images"
                finalPathanims2 = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + themobfolder; // + @"\" + "images"

            }
            else
            {
                finalPathanims1 = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname; // + @"\" + "images"
                finalPathanims2 = prefinalpathtofilesmultiplied + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + themobfolder; // + @"\" + "images"
            ...
            if (thetypeofgenerator == 2)
            {
                finalPathweapon = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + removetheextensionfrommobname + @"\" + "images"; // + @"\" + "images"

            }
            else
            {
                finalPathweapon = prefinalpathtofiles + @"\" + themodfoldernamewithoutextension + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images"; // + @"\" + "images"
            ...
            if (variantindex == 0)
            {
                ...
                if (themodfoldernamewithoutextension.ToLower() == "skeleton" || themodfoldernamewithoutextension.ToLower() == "zombie")
                {
                    finalPathPNGSf = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Front" + @"\" + "Male"; // + @"\" + "images"
                    finalPathPNGSb = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Back" + @"\" + "Male"; // + @"\" + "images"

                }
                else
                {
                    finalPathPNGSf = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Front"; // + @"\" + "images"
                    finalPathPNGSb = prefinalpathtofiles + @"\" + removetheextensionfrommobname + ".mpk" + @"\" + "Content" + @"\" + "Animations" + @"\" + mobname + @"\" + "images" + @"\" + "Back"; // + @"\" + "images"
