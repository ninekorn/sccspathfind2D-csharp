namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    // public class MobWolf : ProtoCharacterMob
    {
        ...
        public static MobSkeletonvariant0 currentMobSkeletonvariant0Class;
        ...
        {
            currentMobSkeletonvariant0Class = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonvariant0Sword>();// ItemWeaponMobSkeletonvariant0Sword //ItemWeaponMobSandTyrantMelee
