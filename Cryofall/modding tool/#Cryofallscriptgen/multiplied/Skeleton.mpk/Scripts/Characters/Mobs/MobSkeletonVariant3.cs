namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant3 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant3 currentMobSkeletonClassVariant3;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000093.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.0400000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant3>();
        ...
        {
            currentMobSkeletonClassVariant3 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant3>();// ItemWeaponMobSkeletonSwordVariant3 //ItemWeaponMobSandTyrantMelee
