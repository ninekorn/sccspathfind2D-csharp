namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant6 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant6 currentMobSkeletonClassVariant6;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000101.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.05200000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant6>();
        ...
        {
            currentMobSkeletonClassVariant6 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant6>();// ItemWeaponMobSkeletonSwordVariant6 //ItemWeaponMobSandTyrantMelee
