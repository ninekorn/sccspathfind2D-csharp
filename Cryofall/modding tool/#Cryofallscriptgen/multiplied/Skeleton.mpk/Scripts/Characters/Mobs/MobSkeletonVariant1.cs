namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant1 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant1 currentMobSkeletonClassVariant1;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000100.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.99900000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant1>();
        ...
        {
            currentMobSkeletonClassVariant1 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant1>();// ItemWeaponMobSkeletonSwordVariant1 //ItemWeaponMobSandTyrantMelee
