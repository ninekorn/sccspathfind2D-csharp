namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant5 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant5 currentMobSkeletonClassVariant5;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000109.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.98400000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant5>();
        ...
        {
            currentMobSkeletonClassVariant5 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant5>();// ItemWeaponMobSkeletonSwordVariant5 //ItemWeaponMobSandTyrantMelee
