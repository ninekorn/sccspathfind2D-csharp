namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant0 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant0 currentMobSkeletonClassVariant0;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000094.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.0300000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant0>();
        ...
        {
            currentMobSkeletonClassVariant0 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant0>();// ItemWeaponMobSkeletonSwordVariant0 //ItemWeaponMobSandTyrantMelee
