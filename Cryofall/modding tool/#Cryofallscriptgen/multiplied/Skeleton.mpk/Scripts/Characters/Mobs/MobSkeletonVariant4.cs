namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant4 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant4 currentMobSkeletonClassVariant4;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000106.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.99100000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant4>();
        ...
        {
            currentMobSkeletonClassVariant4 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant4>();// ItemWeaponMobSkeletonSwordVariant4 //ItemWeaponMobSandTyrantMelee
