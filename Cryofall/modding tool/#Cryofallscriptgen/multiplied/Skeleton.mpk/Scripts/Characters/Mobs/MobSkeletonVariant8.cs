namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant8 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant8 currentMobSkeletonClassVariant8;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000103.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.04900000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant8>();
        ...
        {
            currentMobSkeletonClassVariant8 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant8>();// ItemWeaponMobSkeletonSwordVariant8 //ItemWeaponMobSandTyrantMelee
