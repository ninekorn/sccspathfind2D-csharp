namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant2 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant2 currentMobSkeletonClassVariant2;
        ...
        public override double StatDefaultHealthMax => 000000000000000000000000000000108.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.01600000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant2>();
        ...
        {
            currentMobSkeletonClassVariant2 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant2>();// ItemWeaponMobSkeletonSwordVariant2 //ItemWeaponMobSandTyrantMelee
