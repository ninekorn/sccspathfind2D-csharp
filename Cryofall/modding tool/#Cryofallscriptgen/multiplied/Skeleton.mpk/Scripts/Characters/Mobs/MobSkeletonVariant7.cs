namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobSkeletonVariant7 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobSkeletonVariant7 currentMobSkeletonClassVariant7;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000092.00000000000000000000000000000000;

        public override double StatMoveSpeed => 0000000000000000000000000000002.01300000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonSkeletonVariant7>();
        ...
        {
            currentMobSkeletonClassVariant7 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobSkeletonSwordVariant7>();// ItemWeaponMobSkeletonSwordVariant7 //ItemWeaponMobSandTyrantMelee
