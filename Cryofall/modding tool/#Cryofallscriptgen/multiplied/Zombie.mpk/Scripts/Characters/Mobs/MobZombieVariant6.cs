namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombieVariant6 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombieVariant6 currentMobZombieClassVariant6;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000233.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.50800000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombieVariant6>();
        ...
        {
            currentMobZombieClassVariant6 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobZombieSwordVariant6>();
