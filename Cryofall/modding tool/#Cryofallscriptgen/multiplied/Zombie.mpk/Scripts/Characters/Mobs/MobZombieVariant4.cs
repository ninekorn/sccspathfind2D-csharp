namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombieVariant4 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombieVariant4 currentMobZombieClassVariant4;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000196.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.48700000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombieVariant4>();
        ...
        {
            currentMobZombieClassVariant4 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobZombieSwordVariant4>();
