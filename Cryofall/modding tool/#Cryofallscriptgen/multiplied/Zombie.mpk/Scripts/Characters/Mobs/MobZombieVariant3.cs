namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombieVariant3 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombieVariant3 currentMobZombieClassVariant3;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000187.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.5300000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombieVariant3>();
        ...
        {
            currentMobZombieClassVariant3 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobZombieSwordVariant3>();
