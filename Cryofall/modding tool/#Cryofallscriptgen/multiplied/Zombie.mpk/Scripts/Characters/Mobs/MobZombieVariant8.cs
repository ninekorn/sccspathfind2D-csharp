namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombieVariant8 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombieVariant8 currentMobZombieClassVariant8;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000185.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.52300000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombieVariant8>();
        ...
        {
            currentMobZombieClassVariant8 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobZombieSwordVariant8>();
