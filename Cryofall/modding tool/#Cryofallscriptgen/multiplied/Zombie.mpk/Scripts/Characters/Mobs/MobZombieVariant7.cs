namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobZombieVariant7 : ProtoCharacterMob//, IProtoObjectPsiSource
    // public class MobWolf : ProtoCharacterMob
    {

        public static MobZombieVariant7 currentMobZombieClassVariant7;
        ...
        public override double StatDefaultHealthMax => 00000000000000000000000000000225.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.49200000000000000000000000000000;
            ...
            DropItemsList lootDroplist)
        {
            ...
            skeleton = GetProtoEntity<SkeletonZombieVariant7>();
        ...
        {
            currentMobZombieClassVariant7 = this;

            base.ServerInitializeCharacterMob(data);

            var weaponProto = GetProtoEntity<ItemWeaponMobZombieSwordVariant7>();
