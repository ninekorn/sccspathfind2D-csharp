namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobCrabVariant7 : ProtoCharacterMob
    {
        ...
        public override float CharacterWorldHeight => 0000000000000000.6000000000000000f;

        public override double StatDefaultHealthMax => 00000000000000000000000000000064.00000000000000000000000000000000;

        public override double StatMoveSpeed => 00000000000000000000000000000001.00000000000000000000000000000;
        ...
        {
            skeleton = GetProtoEntity<SkeletonCrabVariant7>();
