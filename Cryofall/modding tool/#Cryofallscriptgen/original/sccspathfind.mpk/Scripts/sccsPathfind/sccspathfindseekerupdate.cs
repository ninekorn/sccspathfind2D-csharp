...
namespace AtomicTorch.CBND.CoreMod.Characters.sccsPathfind
{
    ...
    public static class sccspathfindseekerupdate
    {
       ...
       public static sccspathfinddata sccspathfindseekerupdatefunction(System.Collections.Generic.List<sccspathfindobstaclestruct> listofobstacles, sccspathfinddata sccspathfinddata)//IEnumerator
        {
