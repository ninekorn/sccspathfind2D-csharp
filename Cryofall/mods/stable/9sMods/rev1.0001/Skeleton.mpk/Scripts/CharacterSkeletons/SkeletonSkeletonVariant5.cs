namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant5 : ProtoCharacterSkeletonHuman// SkeletonHuman
    {
        public override SkeletonResource SkeletonResourceBack { get; }
            = new SkeletonResource("SkeletonVariant5/MaleBack");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant5/MaleFront");
...
/*namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant5 : ProtoCharacterSkeleton
    {

        public override SkeletonResource SkeletonResourceBack { get; }
    = new SkeletonResource("SkeletonVariant5/Back");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant5/Front");
        public override void ClientSetupShadowRenderer(IComponentSpriteRenderer shadowRenderer, double scaleMultiplier)
        {
