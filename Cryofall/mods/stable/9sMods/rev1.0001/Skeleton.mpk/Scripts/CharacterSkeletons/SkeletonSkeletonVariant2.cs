namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant2 : ProtoCharacterSkeletonHuman// SkeletonHuman
    {
        public override SkeletonResource SkeletonResourceBack { get; }
            = new SkeletonResource("SkeletonVariant2/MaleBack");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant2/MaleFront");
...
/*namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant2 : ProtoCharacterSkeleton
    {

        public override SkeletonResource SkeletonResourceBack { get; }
    = new SkeletonResource("SkeletonVariant2/Back");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant2/Front");
        public override void ClientSetupShadowRenderer(IComponentSpriteRenderer shadowRenderer, double scaleMultiplier)
        {
