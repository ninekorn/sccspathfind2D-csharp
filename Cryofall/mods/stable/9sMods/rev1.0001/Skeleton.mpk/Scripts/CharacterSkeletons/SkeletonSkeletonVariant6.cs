namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant6 : ProtoCharacterSkeletonHuman// SkeletonHuman
    {
        public override SkeletonResource SkeletonResourceBack { get; }
            = new SkeletonResource("SkeletonVariant6/MaleBack");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant6/MaleFront");
...
/*namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant6 : ProtoCharacterSkeleton
    {

        public override SkeletonResource SkeletonResourceBack { get; }
    = new SkeletonResource("SkeletonVariant6/Back");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant6/Front");
        public override void ClientSetupShadowRenderer(IComponentSpriteRenderer shadowRenderer, double scaleMultiplier)
        {
