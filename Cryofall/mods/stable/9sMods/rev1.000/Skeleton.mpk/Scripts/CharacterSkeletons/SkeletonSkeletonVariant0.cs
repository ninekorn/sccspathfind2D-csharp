namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant0 : ProtoCharacterSkeletonHuman// SkeletonHuman
    {
        public override SkeletonResource SkeletonResourceBack { get; }
            = new SkeletonResource("SkeletonVariant0/MaleBack");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant0/MaleFront");
...
/*namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonSkeletonVariant0 : ProtoCharacterSkeleton
    {

        public override SkeletonResource SkeletonResourceBack { get; }
    = new SkeletonResource("SkeletonVariant0/Back");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("SkeletonVariant0/Front");
        public override void ClientSetupShadowRenderer(IComponentSpriteRenderer shadowRenderer, double scaleMultiplier)
        {
