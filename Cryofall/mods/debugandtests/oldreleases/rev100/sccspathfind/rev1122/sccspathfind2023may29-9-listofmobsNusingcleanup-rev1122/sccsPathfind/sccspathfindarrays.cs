namespace AtomicTorch.CBND.CoreMod.Scripts.sccsPathfind
{
    ...
    {
        public static List<List<ICharacter>> ListOfThisInstanceMob = new();// List<ICharacter>
            ...
            ICharacter characterNpc, out int mobtypeofindex)
        {
            ...
            if (initlists == 0)
            {
                ...
                {
                    ListOfThisInstanceMob.Add(new List<ICharacter>());
            ...
            indexbefore = ListOfThisInstanceMob[thearrayindex].Count;
